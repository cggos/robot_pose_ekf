...
namespace BFL {
/**
 * @brief Non Linear Conditional Gaussian
 * @details
 *     - \f$ \mu = Matrix[1] . ConditionalArguments[0] + Matrix[2]. ConditionalArguments[1]  + ... + Noise.\mu \f$
...
class NonLinearAnalyticConditionalGaussianOdo : public AnalyticConditionalGaussianAdditiveNoise {
   public:
    /**
     * @brief Construct a new Non Linear Analytic Conditional Gaussian Odo object
     * @details
     *      Every Matrix should have the same amount of rows!
